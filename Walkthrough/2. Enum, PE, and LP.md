...
<!-- Table of Contents -->
# <div style="text-align: center; font-size: 24px; color: #4285F4;">Table of Contents</div>

<ol>
    <li><a href="#1-local-enumeration" style="font-size: 18px; color: #EF6C00;">Local Enumeration</a></li>
    <li><a href="#2-autologon-misconfiguration" style="font-size: 18px; color: #AB47BC;">Autologon Misconfiguration</a></li>
    <li><a href="#3-alwaysinstalledelevated-misconfiguration" style="font-size: 18px; color: #43A047;">AlwaysInstalledElevated Misconfiguration</a></li>
    <li><a href="#4-metasploit-alwaysinstalledelevated-misconfiguration" style="font-size: 18px; color: #7B1FA2;">Metasploit (AlwaysInstalledElevated Misconfiguration)</a></li>
    <li><a href="#5-uac-bypass-covenant" style="font-size: 18px; color: #F9A825;">UAC Bypass (Covenant)</a></li>
    <li><a href="#6-uac-bypass-metasploit" style="font-size: 18px; color: #FF5722;">UAC Bypass (Metasploit)</a></li>
    <li><a href="#7-new-user-persistence" style="font-size: 18px; color: #039BE5;">New User Persistence</a></li>
    <li><a href="#8-startup-persistence" style="font-size: 18px; color: #E53935;">Startup Persistence</a></li>
    <li><a href="#9-autorun-persistence" style="font-size: 18px; color: #1976D2;">Autorun Persistence</a></li>
    <li>
        <div style="font-size: 18px; color: #5E35B1;">Session Passing to Metasploit, SOCKS, and Autoroute Module</div>
        <ul>
            <li><a href="#10-session-passing-to-metasploit" style="font-size: 16px; color: #00838F;">Session passing to Metasploit</a></li>
            <li><a href="#10-autoroute" style="font-size: 16px; color: #D81B60;">Autoroute</a></li>
            <li><a href="#10-socks" style="font-size: 16px; color: #43A047;">Socks</a></li>
        </ul>
    </li>
    <li><a href="#11-persistence-via-rdp" style="font-size: 18px; color: #7B1FA2;">Persistence via RDP</a></li>
    <li><a href="#12-hash-cracking-with-hashcat-using-rulelist" style="font-size: 18px; color: #FF5722;">Hash Cracking with Hashcat using Rulelist</a></li>
    <li><a href="#13-cracking-credential-vault-with-covenant" style="font-size: 18px; color: #1976D2;">Cracking Credential Vault with Covenant</a></li>
    <li><a href="#14-cracking-vault-credentials-using-metasploit" style="font-size: 18px; color: #F9A825;">Cracking Vault Credentials using Metasploit</a></li>
</ol>
