...
1. [Local Enumeration](#local-enumeration)
2. [Autologon Misconfiguration](#autologon-misconfiguration)
3. [AlwaysInstalledElevated Misconfiguration](#alwaysinstalledelevated-misconfiguration)
4. [Metasploit (AlwaysInstalledElevated Misconfiguration)](#metasploit-alwaysinstalledelevated-misconfiguration)
5. [UAC Bypass (Covenant)](#uac-bypass-covenant)
6. [UAC Bypass (Metasploit)](#uac-bypass-metasploit)
7. [New User Persistence](#new-user-persistence)
8. [Startup Persistence](#startup-persistence)
9. [Autorun Persistence](#autorun-persistence)
10. [Session Passing to Metasploit, SOCKS, and Autoroute Module](#session-passing-to-metasploit-socks-and-autoroute-module)
    10.1 [Session passing to Metasploit](#session-passing-to-metasploit)
    10.2 [Autoroute](#autoroute)
    10.3 [Socks](#socks)
11. [Persistence via RDP](#persistence-via-rdp)
12. [Hash Cracking with Hashcat using Rulelist](#hash-cracking-with-hashcat-using-rulelist)
13. [Cracking Credential Vault with Covenant](#cracking-credential-vault-with-covenant)
14. [Cracking Vault Credentials using Metasploit](#cracking-vault-credentials-using-metasploit)
