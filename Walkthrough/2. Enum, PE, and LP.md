...
- As we have high integrity user session on Covenant we can do persistence by adding a new user in ocal admin group.
...
- When we restart the system we will grant with a new Grunt connection to our Covenant.
